  ...
  for (let i = 0; i < selector.length; i++) {
    ...
    if (mode & 4) {
      ...
      if (mode & 8 && tNode.attrs !== null) {
        if (
          !isCssClassMatching(tNode.attrs, selectorAttrValue, isProjectionMode)
        ) {
          if (isPositive(mode)) return false;
          skipToNextSelector = true;
        }
      ...
      if (selectorAttrValue !== "") {
        ...
        if (
          (compareAgainstClassName &&
            classIndexOf(compareAgainstClassName, selectorAttrValue, 0) !==
              -1) ||
      ...
      switch (opCode) {
        case ICU_MARKER:
          ...
          if (lView[commentNodeIndex] === null) {
            ...
            const commentRNode = (lView[commentNodeIndex] = createCommentNode(
              renderer,
              commentValue,
            ));
        ...
        case ELEMENT_MARKER:
          ...
          if (lView[elementNodeIndex] === null) {
            ...
            const elementRNode = (lView[elementNodeIndex] = createElementNode(
              renderer,
              tagName,
              null,
            ));
  ...
  if (processOutputs && outputs !== null && (props = outputs[eventName])) {
    ...
    if (propsLength) {
      for (let i = 0; i < propsLength; i += 2) {
        ...
        if (tCleanup) {
          const cleanupIdx =
            typeof subscriptionOrCallback === "function" ? idx + 1 : -(idx + 1);
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-74DU7V4E.js.map
