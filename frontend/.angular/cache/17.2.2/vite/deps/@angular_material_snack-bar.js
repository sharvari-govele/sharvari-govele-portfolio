import { DOCUMENT, Location, isPlatformBrowser } from "./chunk-53NVKCCG.js";
import {
...
var _RippleRenderer = class _RippleRenderer {
  ...
  _removeTriggerEvents() {
    ...
    if (trigger2) {
      pointerDownEvents.forEach((type) =>
        _RippleRenderer._eventManager.removeHandler(type, trigger2, this),
      );
      if (this._pointerUpEventsRegistered) {
        pointerUpEvents.forEach((type) =>
          trigger2.removeEventListener(
            type,
            this,
            passiveCapturingEventOptions,
          ),
...
var _CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  measureRangeSize(range2, orientation) {
    ...
    if (
      (range2.start < this._renderedRange.start ||
        range2.end > this._renderedRange.end) &&
      (typeof ngDevMode === "undefined" || ngDevMode)
    ) {
